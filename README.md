...
<p align="center">
  <a href="#031-更新亮点">0.3.1 更新</a> &bull;
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.3.1-orange?style=flat-square" alt="Version" />
...
测试套件包含 **116 项单元测试**，覆盖模型、服务和工具类，使用 xUnit + Moq。
